...
- Escolha livros diferentes no menu.
- Pesquise uma referência, um título de discurso e uma subpasta de qualquer livro.
...
A instalação no iPad será feita pelo BRAT depois que esta versão for publicada no GitHub. Isso evita manipular manualmente a pasta interna de plugins do Obsidian no iOS.
