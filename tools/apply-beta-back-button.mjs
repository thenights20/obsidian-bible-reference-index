...
'}\n' +
'.indice-nights-back-to-index:hover { background: var(--background-modifier-hover); color: var(--text-accent); }\n' +
'.indice-nights-back-to-index:disabled { opacity:.6; cursor:wait; }\n' +
'@media (max-width: 600px) { .indice-nights-back-to-index { top:54px; right:12px; padding:.5rem .7rem; } }\n';
